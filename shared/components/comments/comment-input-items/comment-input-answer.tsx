...
interface ChatInputProps {
	...
	parentCommentAuthorName: string; // Новый проп для имени автора родительского комментария
}
...
export const CommentInputAnswer = ({ apiUrl, query, setIsReplying, parentCommentAuthorName }: ChatInputProps) => {
	...
	const form = useForm<z.infer<typeof formSchema>>({
		...
		defaultValues: {
			content: parentCommentAuthorName ? `@${parentCommentAuthorName}, ` : '' // Установка значения по умолчанию
		}
	})
