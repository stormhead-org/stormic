...
// Интерфейс конфигурации встраивания
...
function AutoEmbedMenu({
	...
	return (
		<PopoverContent className='typeahead-popover'>
			<ul>
...
function useModal() {
	...
	const showModal = (
		...
		setIsOpen(true)
		setContent(getContent(() => setIsOpen(false)))
	}
