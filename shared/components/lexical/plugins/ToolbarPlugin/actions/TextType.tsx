import { blockTypeToBlockName, useToolbarState } from '@/shared/components/lexical/context/ToolbarContext'
import {
	formatBulletList, formatCheckList, formatCode,
	formatHeading, formatNumberedList,
	formatParagraph, formatQuote
...
export const TextType: React.FC<Props> = ({ editor, blockType, disabled = false, className }) => {
