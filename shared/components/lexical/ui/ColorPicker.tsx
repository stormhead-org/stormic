...
export default function ColorPicker({
	...
	return (
		<div className='p-5' style={{ width: WIDTH }} ref={innerDivRef}>
				...
				{basicColors.map(basicColor => (
					<button
						className={`h-4 w-4 rounded-full border border-gray-300 cursor-pointer ${
							basicColor === selfColor.hex ? 'shadow-md' : ''
						}`}
						key={basicColor}
			...
			>
				<div
					className='absolute w-5 h-5 rounded-full border-2 border-white shadow-md transform -translate-x-2.5 -translate-y-2.5'
					style={{
			...
			>
				<div
					className='absolute w-5 h-5 rounded-full border-2 border-white shadow-[0_0_0_0.5px_black]'
					style={{
			...
			<div
				className='border border-gray-300 mt-4 w-full h-5'
