...
export const CommunityStyleForm: React.FC<Props> = ({ setType, onClose }) => {
	...
	const isLoading =
		formLogo.formState.isSubmitting || formBanner.formState.isSubmitting
	...
	return (
		<div className='flex flex-col gap-4'>
			<div className='flex justify-between items-center'>
				<div className='mr-2'>
					<Title text='Стилизация сообщества' size='md' className='font-bold' />
					<p className='text-gray-400'>
						Визуальное оформление привлечет внимание новых участников и поможет
						создать культуру вашего сообщества! Вы можете обновить его в любое
						время.
					</p>
				</div>
			</div>
			...
			<Form {...formLogo}>
				<form onSubmit={formLogo.handleSubmit(onSubmit)}>
					<p className='flex justify-center'>Логотип</p>
			...
			<Form {...formBanner}>
				<form onSubmit={formBanner.handleSubmit(onSubmit)}>
					<p className='flex justify-center'>Баннер</p>
					<div className='flex items-center justify-center text-center mt-2'>
						<FormField
