...
/**
 * Formats an array of author from Posts into a prettified string.
 * @param authors - The author array from a Post.
...
export const formatAuthors = (
	authors: NonNullable<NonNullable<Post['author']>[number]>[]
) => {
	...
	return `${authorNames.slice(0, -1).join(', ')} and ${
