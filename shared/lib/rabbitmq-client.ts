...
export async function consumePostViewQueue(
	onMessage: (msg: Message) => Promise<void>
) {
...
export async function sendPostLikeMessage(message: {
	action: string
	postId: number
	userId: number
}) {
...
export async function consumePostLikeQueue(
	onMessage: (msg: Message) => Promise<void>
) {
...
export async function sendBookmarkAddMessage(message: {
	action: string
	postId: number
	userId: number
}) {
...
export async function consumeBookmarkAddMQueue(
	onMessage: (msg: Message) => Promise<void>
) {
...
export async function sendCommentLikeMessage(message: {
	action: string
	commentId: number
	userId: number
}) {
...
export async function consumeCommentLikeQueue(
	onMessage: (msg: Message) => Promise<void>
) {
...
export async function sendFollowMessage(message: {
	action: string
	followerId: number
	followingId: number
}) {
...
export async function consumeFollowQueue(
	onMessage: (msg: Message) => Promise<void>
) {
...
export async function consumeCommunityFollowQueue(
	onMessage: (msg: Message) => Promise<void>
) {
